...
const jsFiles=[
  "src/auth.js","src/casino-main.js","src/games/aureus.js","src/games/honey-fruits.js",
  ...
  "public/game/games/GiantBeeController.js","public/game/games/HoneyFruitsController.js",
  "scripts/deploy.mjs","tests/aureus-engine.test.mjs","tests/honey-fruits.test.mjs"
];
...
const jsonFiles=["public/assets/assets.manifest.json","public/assets/games/aureus/config.json","public/assets/games/aureus/atlas/symbols.json","public/assets/games/honey-fruits/config.json","public/assets/games/honey-fruits/atlas/symbols.json"];
...
execFileSync(process.execPath,["--test",resolve(root,"tests/aureus-engine.test.mjs"),resolve(root,"tests/honey-fruits.test.mjs")],{stdio:"inherit"});
