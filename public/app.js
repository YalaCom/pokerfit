...
async function boot(){
  ...
  tg.ready();tg.expand();state.initData=tg.initData;bindSettings();bindGlobal();initPoker();initBlackjack();initSocial();initCasino();initAdvancedSlots();initPokerEnhancements();initLuxuryUI();
